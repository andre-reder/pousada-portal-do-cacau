...
const ADVENTURES: Adventure[] = [
  {
    ...
    text: "A trilha mais acessível, ideal para famílias e para quem quer um primeiro contato com as cachoeiras da região. Saída às 10h, volta às 17h, com tempo para banho e contemplação.",
  },
  {
    ...
    level: "Médio",
    destination: "Rio Una",
    text: "Percurso pelo rio Una com várias quedas d'água para banho. Nível médio, adequado para quem tem um pouco de fôlego — a recompensa são poços naturais cercados pela mata.",
  },
  {
    ...
    text: "Outra rota de nível médio pelas cachoeiras do ribeirão de Itu, com paisagens preservadas e paradas para mergulho nas águas cristalinas.",
  },
  {
    ...
    text: "A trilha mais desafiadora — para aventureiros que querem chegar a uma praia praticamente deserta. Nível difícil, saída às 10h e volta às 17h, com trechos de subida e mata fechada.",
  },
  {
  ...
  },
  {
    ...
    text: "Passeio de canoa havaiana até As Ilhas, com aproximadamente 2 horas de duração. Inclui água, frutas e máscara de mergulho para snorkel no percurso.",
  },
  {
    ...
    text: "Passeio de barco pelas ilhas da região, com aproximadamente 3 horas de duração. Aluguel de máscara de mergulho e snorkel disponível para explorar a vida marinha.",
  },
  {
    ...
    text: "O arquipélago impressiona pela beleza e abriga expressiva biodiversidade marinha e insular, protegida por unidades de conservação. Uma viagem por um dos cartões-postais do litoral norte.",
  },
  {
    ...
    text: "Rapel de 10m indicado para aventureiros de primeira viagem. A trilha até o ponto tem 2km e é conhecida como Trilha dos Mirantes, com vistas incríveis de toda a praia de Paúba.",
  },
];
          ...
          <AnimatePresence mode="wait">
            {filtered.map((a, i) => (
              <motion.article
                ...
                whileHover={{ y: -5 }}
                className="group flex flex-col rounded-[var(--radius-card)] border border-[#d9cfb8] bg-[#fbf6ea] p-6 shadow-[var(--shadow-subtle)] transition-shadow duration-300 hover:shadow-[var(--shadow-elevated)] sm:p-7"
              >
                <div className="flex items-start justify-between gap-4">
                  ...
                  <span
                    className={`mt-1 shrink-0 rounded-full border px-3 py-1 text-[0.65rem] font-bold uppercase tracking-[0.12em] ${levelColor[a.level]}`}
                  >
                    {a.level}
                  </span>
                </div>
